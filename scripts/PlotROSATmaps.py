...
#Use: python PlotROSATmaps.py bandID
...
#Load Xray map
XrayMap = np.loadtxt("../maps/ROSAT_R"+str(bandID)+"_rate.txt")
...
ax1.set_title('ROSAT Soft X-ray Background '+bandtext, fontsize=12)
...
pl.savefig('../plots/ROSAT_R' + str(bandID) +'_fullsky.pdf', bbox_inches="tight")